...
define('_WEBSITE_NAME', 'XOOPS 網站');
define('_WEBSITE_SLOGAN', '就用它吧！');
define('_WEBSITE_META_KEYWORDS', 'xoops、Web 應用程式框架、cms、內容管理系統');
define('_WEBSITE_FOOTER', "技术支持 XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>XOOPS 项目</a>");
define('_WEBSITE_COPYRIGHT', '版權所有 © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS 是一個以 PHP 編寫的基於動態物件導向的開源入口網站腳本。');
