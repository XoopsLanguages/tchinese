...
define('_OXYGEN_XOOPSTHEMES', 'XOOPS 佈景主題');
define('_OXYGEN_XOOPSMODULES', 'XOOPS 模組');
define('_OXYGEN_INTERESTSITES', '連結');
define('_OXYGEN_LOCALSUPPORT', '在地支援');
...
define('_OXYGEN_ABOUT_TEXT', '閱讀 <a href="https://xoops.org/modules/wfchannel/" rel="external">All about XOOPS</a> 頁面以了解更多詳細資訊。');
define('_OXYGEN_XOOPS_LINKS', 'XOOPS 連結');
define('_OXYGEN_XOOPSPROJECT', 'XOOPS 專案');
define('_OXYGEN_XOOPSCORE', 'XOOPS 核心');
define('_OXYGEN_XOOPSTHEME', 'XOOPS 佈景主題');
...
define('_OXYGEN_AUTHENTICATION', '驗證選項');
define('_OXYGEN_MODULESETTINGS', '系統模組設定');
//Add for styles name
define('_OXYGEN_SILVER', '銀色');
define('_OXYGEN_DARK', '深色');
define('_OXYGEN_ORANGE', '橘色');
//Add 10 des
define('_OXYGEN_XOOPS_LICENSE', 'XOOPS 授權');
define('_OXYGEN_RSS', 'RSS Feed');
define('_OXYGEN_ADMINISTRATION', 'XOOPS 管理');
define('_OXYGEN_UPTOP', '回到頂端');
//Add help
define('_OXYGEN_HELP_1', '我如何使用 XOOPS 建立內容？');
define('_OXYGEN_HELP_DESC_1', '要建立內容，您必須先安裝一個內容模組，例如 <a href="https://github.com/XoopsModules25x/publisher" rel="external">Publisher</a> 或 <a href="https://github.com/XoopsModules25x/news" rel="external">News</a> 模組。要了解更多關於 XOOPS 模組的資訊，<a href="modules/system/help.php?mid=1&page=modulesadmin">請按一下這裡</a>');
define('_OXYGEN_HELP_2', '什麼是區塊？');
define('_OXYGEN_HELP_DESC_2', '區塊可以提供已安裝模組的額外/特定內容。可以有包含文字、JS 程式碼、HTML 格式文字、圖片等的自訂區塊。這些區塊中的內容可以單獨格式化，也可以繼承網站的格式。（<a href="modules/system/help.php?mid=1&page=blocksadmin">更多...</a>）');
define('_OXYGEN_HELP_3', '我如何找到更多幫助？');
define('_OXYGEN_HELP_DESC_3', '如果您需要更多關於使用 XOOPS 的幫助和資訊，您可以使用系統模組中的 <a href="modules/system/help.php">說明頁面</a>，或使用 <a href="https://xoops.org/modules/xoopspartners/" rel="external">XOOPS 在地支援網站</a>');

//2.5.12
define('_OXYGEN_COMPOSER_PACKAGES', 'Composer 軟體包');
